; (function($) {
    ...
    $(document).ready(function() {
        $(document).on('click', '.navbar-area .navbar-nav li.menu-item-has-children>a',
        function (e) {
            e.preventDefault();
        });
        $('.navbar-area .menu').on('click',
        function() {
        ...
        $galleryFilterMenu.on('click', 'button, a',
        function() {
            var $this = $(this),
    ...
    function() {
        ...
        backtoTop.fadeOut();
        $(document).on('click', '.cancel-preloader a',
        function(e) {
            e.preventDefault();
